...
Permissions to access a securable object are granted by the security descriptor.
    - Security descriptor classifies permissions into two types of Access Control Lists (ACLs):
