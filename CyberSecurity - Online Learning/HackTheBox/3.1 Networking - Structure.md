...
The **OSI stands for Open Systems Interconnection model** published by the **international telecommunication Union (ITU)** and is often referred to as the ISO/OSI layer model.